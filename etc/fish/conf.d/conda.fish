set -gx CONDA_EXE (cygpath "C:/anaconda\Scripts\conda.exe")
set _CONDA_ROOT (cygpath "C:/anaconda")
set _CONDA_EXE (cygpath "C:/anaconda\Scripts\conda.exe")
set -gx CONDA_PYTHON_EXE (cygpath "C:/anaconda\python.exe")
