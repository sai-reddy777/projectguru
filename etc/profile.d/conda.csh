setenv CONDA_EXE `cygpath C:/anaconda\Scripts\conda.exe`
setenv _CONDA_ROOT `cygpath C:/anaconda`
setenv _CONDA_EXE `cygpath C:/anaconda\Scripts\conda.exe`
setenv CONDA_PYTHON_EXE `cygpath C:/anaconda\python.exe`
